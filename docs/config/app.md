...
The frontend that Levity will use. Currently, only Qt (PySide6) is supported — supporting more frontends is a core goal of the [roadmap](/development/roadmap.md).
