...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.unit = QLabel(self.mainFrame)
        ...
        self.unit.setFont(font2)
        self.unit.setAlignment(Qt.AlignHCenter|Qt.AlignTop)
        self.unit.setIndent(0)

        self.centerCluster.addWidget(self.unit)
        ...
        sizePolicy4.setHeightForWidth(self.subDataFrame.sizePolicy().hasHeightForWidth())
        self.subDataFrame.setSizePolicy(sizePolicy4)
        font3 = QFont()
        ...
        sizePolicy5.setHeightForWidth(self.gustTitle.sizePolicy().hasHeightForWidth())
        self.gustTitle.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.gustValueLabel.sizePolicy().hasHeightForWidth())
        self.gustValueLabel.setSizePolicy(sizePolicy6)
        ...
        sizePolicy5.setHeightForWidth(self.maxTitle.sizePolicy().hasHeightForWidth())
        self.maxTitle.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.maxValueLabel.sizePolicy().hasHeightForWidth())
        self.maxValueLabel.setSizePolicy(sizePolicy6)
    ...
    def retranslateUi(self, Frame):
        ...
        self.unit.setText(QCoreApplication.translate("Frame", u" mph", None))
        ...
        self.maxTitle.setText(QCoreApplication.translate("Frame", u"Max: ", None))
