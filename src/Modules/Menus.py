...
class InsertMenu(QMenu):
	...
	def __init__(self, parent):
		...
		self.templates = self.addMenu(TemplateMenu(self, EasyPath(config.userPath).templates.panels))
...
class TemplateMenu(QMenu):
	...
	def __init__(self, parent, directoryPath: Union[str, Path], *args, **kwargs):
		from src.Modules.Panel import PanelFromFile
		self.parent = parent
...
__all__ = ['BaseContextMenu', 'LabelContextMenu', 'TimeContextMenu', 'CentralPanelContextMenu', 'EditableLabelContextMenu']
