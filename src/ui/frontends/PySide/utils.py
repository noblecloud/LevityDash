...
from src.utils import ClosestMatchEnumMeta, getItemsWithType


def itemLoader(parent, item: dict):
	from src.ui.frontends.PySide.Modules import Realtime, Clock, Panel, GraphPanel, EditableLabel, Moon
	item['parent'] = parent
...
def findSizePosition(*args, **kwargs):
	from src.utils.geometry import Position, Size
