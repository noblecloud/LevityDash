...
from src.EasyPath import FileLocation
from src.utils.shared import boolFilter, clearCacheAttr, disconnectSignal, getItemsWithType, Numeric, SimilarValue, _Panel
from src.utils.geometry import Edge, LocationFlag, Margins, polygon_area, Position

from src.utils.log import LevityGUILog as log
from src.ui.frontends.PySide.utils import debugPen, DisplayType, gridPen, selectionPen, colorPalette, findScene, findSizePosition, GraphicsItemSignals, hasState, itemLoader
from src.ui.frontends.PySide.Modules.Menus import BaseContextMenu
from src.ui.frontends.PySide.Modules.Handles import Handle, HandleGroup
from src.ui.frontends.PySide.Modules.Handles.Resize import ResizeHandles
from src.ui.frontends.PySide.Modules.Handles.Grid import GridAdjusters
...
class Panel(_Panel):
	...
	def dropEvent(self, event: QGraphicsSceneDragDropEvent):
		from src.ui.frontends.PySide.Modules import Realtime
		def hook(object: dict):
			from src.plugins.dispatcher import ValueDirectory
