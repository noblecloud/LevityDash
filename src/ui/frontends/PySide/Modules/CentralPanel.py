...
from src.ui.frontends.PySide.Modules.Drawer import RadialMenuItem
from src.Geometry import Geometry
from src.ui.frontends.PySide.utils import hasState, itemLoader
from src.ui.frontends.PySide.Modules.Menus import CentralPanelContextMenu
...
class CentralPanel(Panel):
	...
	def _save(self, path: Path = None, fileName: str = None):
		...
		# try:
		tempFile = NamedTemporaryFile(dir=str(path), prefix=fileName, suffix='.temp', delete=True, mode='w')
		with tempFile as f:
