...
schema = {
	...
	'environment.clouds.cover.low':                 {
		...
		'sourceKey':      'cloudcover_low',
		'timeseriesOnly': True,
	},
	'environment.clouds.cover.mid':                 {
		'type':           'cloudcover',
		'sourceUnit':     '%',
		'title':          'Cloud Cover Mid',
		'description':    'Cloud cover mid',
		'sourceKey':      'cloudcover_mid',
		'timeseriesOnly': True,
	},
	'environment.condition.weatherCode':            {
		'type':           'WeatherCode',
		'sourceUnit':     'WeatherCode',
		'title':          'Weather code',
		'description':    'Weather code',
		'sourceKey':      'weathercode',
		'timeseriesOnly': True,
	},
	'environment.condition.icon':                   {
		'type':        'icon',
		'sourceUnit':  'int',
		'title':       'Condition Icon',
		'description': 'Condition Icon',
		'dataKey':     'environment.condition.weatherCode',
		'iconType':    'glyph',
	...
	'environment.humidity.humidity':                {
		...
		'sourceKey':   'relativehumidity_2m',
	},
	'environment.light.irradiance.daily':           {
		'type':        'radiation',
		'sourceUnit':  'MJ/m^2',
		'title':       'Total Shortwave Radiation',
		'description': 'Total shortwave radiation for the day',
		'sourceKey':   'shortwave_radiation_sum',
	},
	'environment.light.irradiance.diffuse':         {
		...
		'sourceKey':      'diffuse_radiation',
		'timeseriesOnly': True,
	},
	'environment.light.irradiance.diffuseNormal':   {
		'type':        'irradiance',
		'sourceUnit':  'W/m^2',
		'title':       'Diffuse normal irradiance',
		'description': 'Diffuse normal irradiance',
		'sourceKey':   'diffuse_normal_irradiance',
	},
	'environment.light.irradiance.direct':          {
		...
		'sourceKey':      'direct_radiation',
		'timeseriesOnly': True,
	},
	'environment.light.irradiance.directNormal':    {
		'type':        'irradiance',
		'sourceUnit':  'W/m^2',
		'title':       'Direct normal irradiance',
		'description': 'Direct normal irradiance',
		'sourceKey':   'direct_normal_irradiance',
	},
	'environment.light.irradiance.global':          {
		'type':           'irradiance',
		'sourceUnit':     'W/m^2',
		'title':          'Global irradiance',
		'description':    'Global irradiance',
		'sourceKey':      'global_irradiance',
		'timeseriesOnly': True,
	},
	'environment.light.irradiance.irradiance':      {
		...
		'sourceKey':      'shortwave_radiation',
		'timeseriesOnly': True,
	},
	'environment.light.sunrise':                    {
		'type':           'datetime',
		'sourceUnit':     'ISO8601',
		'format':         '%Y-%m-%dT%H:%M',
		'title':          'Sunrise',
	...
	'environment.precipitation.daily':              {
		'type':           'precipitationDaily',
		'sourceUnit':     ['mm', 'day'],
		'title':          'Precipitation Daily',
		'description':    'Precipitation daily',
		'sourceKey':      'precipitation_sum',
		'timeseriesOnly': True,
	},
	'environment.precipitation.showers':            {
		'type':           'precipitationHourly',
		'sourceUnit':     ['mm', 'hr'],
		'title':          'Showers',
		'description':    'Showers',
		'sourceKey':      'showers',
	...
	'environment.precipitation.show':               {
		'type':           'precipitationHourly',
		'sourceUnit':     ['mm', 'hr'],
		'title':          'Snow',
		'description':    'Snow',
	...
	'environment.precipitation.showersDaily':       {
		'type':           'precipitationDaily',
		'sourceUnit':     ['mm', 'day'],
		'title':          'Showers Daily',
		'description':    'Showers Daily',
		'sourceKey':      'showers',
		'timeseriesOnly': True,
	},
	'environment.precipitation.rainDaily':          {
		'type':           'precipitationDaily',
		'sourceUnit':     ['mm', 'day'],
		'title':          'Rain Daily',
		'description':    'Rain Daily',
		'sourceKey':      'rain',
		'timeseriesOnly': True,
	},
	'environment.precipitation.showDaily':          {
		'type':           'precipitationDaily',
		'sourceUnit':     ['mm', 'day'],
		'title':          'Snow Daily',
		'description':    'Snow Daily',
		'sourceKey':      'snowfall',
		'timeseriesOnly': True,
	},
	...
	'environment.precipitation.snowDepth':          {
		'type':           'precipitation',
		'sourceUnit':     'm',
		'title':          'Snow depth',
		'description':    'Snow depth',
		'sourceKey':      'snow_depth',
		'timeseriesOnly': True,
	},
	'environment.precipitation.time':               {
		...
		'description':    'Precipitation time',
		'sourceKey':      'precipitation_hours',
		'timeseriesOnly': True,
	},
	'environment.pressure.pressure':                {
		...
		'sourceUnit':  'hPa',
		'title':       'Pressure',
		'description': 'Pressure at 2m height',
		'sourceKey':   'pressure_msl',
	},
	...
	'environment.pressure.vaporPressureDeficit':    {
		'type':           'pressure',
		'sourceUnit':     'kPa',
		'title':          'Vapor Pressure Deficit',
		'description':    'Vapor pressure deficit',
		'sourceKey':      'vapor_pressure_deficit',
		'timeseriesOnly': True,
	},
	'environment.soil.freezingLevelHeight':         {
		'type':           'length',
		'sourceUnit':     'm',
		'title':          'Freezing level height',
		'description':    'Freezing level height',
		'sourceKey':      'freezinglevel_height',
		'timeseriesOnly': True,
	},
	'environment.soil.moisture.moisture':           {
		'type':           'soil',
		'sourceUnit':     '%',
		'title':          'Soil Moisture',
		'description':    'Soil moisture',
		'sourceKey':      'soil_moisture_0_1cm',
		'timeseriesOnly': True,
	},
	'environment.soil.moisture.1-3cm':              {
		'type':           'soil',
		'sourceUnit':     '%',
		'title':          'Soil Moisture [1-3cm]',
		'description':    'Soil moisture at 1-3cm depth',
		'sourceKey':      'soil_moisture_1_3cm',
		'timeseriesOnly': True,
	},
	'environment.soil.moisture.3-9cm':              {
		'type':           'soil',
		'sourceUnit':     '%',
		'title':          'Soil Moisture [3-9cm]',
		'description':    'Soil moisture at 3-9cm depth',
		'sourceKey':      'soil_moisture_3_9cm',
		'timeseriesOnly': True,
	},
	'environment.soil.moisture.9-27cm':             {
		'type':           'soil',
		'sourceUnit':     '%',
		'title':          'Soil Moisture [9-27cm]',
		'description':    'Soil moisture at 9-27cm depth',
		'sourceKey':      'soil_moisture_9_27cm',
		'timeseriesOnly': True,
	},
	'environment.soil.moisture.27-81cm':            {
		'type':           'soil',
		'sourceUnit':     '%',
		'title':          'Soil Moisture [27-81cm]',
		'description':    'Soil moisture at 27-81cm depth',
		'sourceKey':      'soil_moisture_27_81cm',
		'timeseriesOnly': True,
	},
	'environment.soil.moisture.evapotranspiration': {
		'type':           'rate',
		'sourceUnit':     ['mm', 'hr'],
		'title':          'Evapotranspiration',
		'description':    'Evapotranspiration',
		'sourceKey':      'evapotranspiration',
		'timeseriesOnly': True,
	},
	...
	'environment.temperature.dewpoint':             {
		...
		'sourceUnit':  'c',
		'title':       'Dew Point',
		'description': 'Dew Point at 2m height',
		'sourceKey':   'dewpoint_2m',
	},
	'environment.temperature.feelsLike':            {
		'type':        'temperature',
		'sourceUnit':  'c',
		'title':       'Feels Like',
		'description': 'Apparent temperature at 2m height',
		'sourceKey':   'apparent_temperature',
	},
	'environment.temperature.feelsLikeHigh':        {
		'type':           'temperature',
		'sourceUnit':     'c',
		'title':          'Feels Like High',
		'description':    'Feels like high',
		'sourceKey':      'apparent_temperature_max',
		'timeseriesOnly': True,
	},
	'environment.temperature.feelsLikeLow':         {
		'type':           'temperature',
		'sourceUnit':     'c',
		'title':          'Feels Like Low',
		'description':    'Feels like low',
		'sourceKey':      'apparent_temperature_min',
		'timeseriesOnly': True,
	},
	...
	'environment.temperature.temperature':          {
		...
		'sourceKey':   'temperature_2m',
	},
	'environment.wind.direction.80m':               {
		'type':           'direction',
		'sourceUnit':     'º',
		'title':          'Wind Direction [80m]',
		'description':    'Wind direction at 80m height',
		'sourceKey':      'winddirection_80m',
		'timeseriesOnly': True,
	},
	'environment.wind.direction.120m':              {
		'type':           'direction',
		'sourceUnit':     'º',
		'title':          'Wind Direction [120m]',
		'description':    'Wind direction at 120m height',
		'sourceKey':      'winddirection_120m',
		'timeseriesOnly': True,
	},
	'environment.wind.direction.180m':              {
		'type':           'direction',
		'sourceUnit':     'º',
		'title':          'Wind Direction [180m]',
		'description':    'Wind direction at 180m height',
		'sourceKey':      'winddirection_180m',
		'timeseriesOnly': True,
	},
	'environment.wind.direction.direction':         {
		'type':           'direction',
		'sourceUnit':     'º',
		'title':          'Wind Direction',
		'description':    'Wind direction at 10m height',
		'sourceKey':      'winddirection_10m',
		'timeseriesOnly': True,
	},
	'environment.wind.direction.dominant':          {
		'type':           'direction',
		'sourceUnit':     'º',
		'title':          'Wind Direction',
		'description':    'Wind direction',
		'sourceKey':      'winddirection_10m_dominant',
		'timeseriesOnly': True,
	},
	'environment.wind.speed.80m':                   {
		'type':           'wind',
		'sourceUnit':     ['km', 'hr'],
		'title':          'Wind Speed [80m]',
		'description':    'Wind speed at 80m height',
		'sourceKey':      'windspeed_80m',
		'timeseriesOnly': True,
	},
	'environment.wind.speed.120m':                  {
		'type':           'wind',
		'sourceUnit':     ['km', 'hr'],
		'title':          'Wind Speed [120m]',
		'description':    'Wind speed at 120m height',
		'sourceKey':      'windspeed_120m',
		'timeseriesOnly': True,
	},
	'environment.wind.speed.180m':                  {
		'type':           'wind',
		'sourceUnit':     ['km', 'hr'],
		'title':          'Wind Speed [180m]',
		'description':    'Wind speed at 180m height',
		'sourceKey':      'windspeed_180m',
		'timeseriesOnly': True,
	},
	'environment.wind.speed.gust':                  {
		...
		'sourceUnit':     ['km', 'hr'],
		'title':          'Wind Gusts',
		'description':    'Wind gusts at 10m height',
		'sourceKey':      'windgusts_10m',
		'timeseriesOnly': True,
	},
	'environment.wind.speed.gustMax':               {
		'type':           'wind',
		'sourceUnit':     ['km', 'hr'],
		'title':          'Wind Gusts Max',
		'description':    'Max wind gusts for the day at 10m height',
		'sourceKey':      'windgusts_10m_max',
		'timeseriesOnly': True,
	},
	'environment.wind.speed.gustMin':               {
		'type':           'wind',
		'sourceUnit':     ['km', 'hr'],
		'title':          'Wind Gusts Min',
		'description':    'Min wind gusts for the day at 10m height',
		'sourceKey':      'windgusts_10m_min',
		'timeseriesOnly': True,
	},
	'environment.wind.speed.max':                   {
		'type':           'wind',
		'sourceUnit':     ['km', 'hr'],
		'title':          'Wind Speed Max',
		'description':    'Wind speed max',
		'sourceKey':      'windspeed_10m_max',
		'timeseriesOnly': True,
	},
	'environment.wind.speed.min':                   {
		'type':           'wind',
		'sourceUnit':     ['km', 'hr'],
		'title':          'Wind Speed Min',
		'description':    'Wind speed min',
		'sourceKey':      'windspeed_10m_min',
		'timeseriesOnly': True,
	},
	'environment.wind.speed.speed':                 {
		...
		'sourceKey':      'windspeed_10m',
		'timeseriesOnly': True,
	},
	'timestamp':                                    {
		'type':        'datetime',
		'sourceUnit':  'ISO8601',
		'format':      {'hourly': '%Y-%m-%dT%H:%M', 'daily': '%Y-%m-%d'},
		'title':       'Time',
		'description': 'Time',
		'sourceKey':   'time',
		tsk.metaData:  '@timestamp',
	},
	'dataMaps':                                     {'forecast': {'daily': 'daily', 'hourly': 'hourly'}},
	'aliases':                                      {
...
class OpenMeteo(REST, realtime=False, hourly=True, daily=True, recorded=True):
	urls = OpenMeteoURLs()
	schema = schema
	name = 'OpenMeteo'
	...
	def start(self):
		...
		async def async_bootstrap():
			...
			await self.future
			self.pluginLog.info('OpenMeteo: starting shutdown')

		def bootstrap():
			self.requestTimer = ScheduledEvent(timedelta(minutes=15), self.getForecast, loop=loop).start()
	...
	async def getForecast(self):
		...
		self.loop.create_task(self.daily.asyncUpdate(data))
