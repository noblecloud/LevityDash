from src.Geometry import Geometry, log
...
from src.utils.geometry import GridItemPosition, GridItemSize, MultiDimension, Position
from src.Geometry.utils import GridItem
