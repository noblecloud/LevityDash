...
class WFUnits(UnitTranslator):
	_time = _SmartDictionary({'type': 'datetime', 'unit': 'date'})
	_temperature = _SmartDictionary({'temperature': {'type': 'heat', 'unit': 'c'},
	...
	_lightning = _SmartDictionary({'strikeCount':       {'type': 'quantity', 'unit': 'int'},
	                               'lightningDistance': {'type': 'length', 'unit': 'km'},
	                               'lightning1hr':      {'type': 'quantity', 'unit': 'int'},
	                               'lightning3hr':      {'type': 'quantity', 'unit': 'int'}})
	_battery = _SmartDictionary({'type': 'power', 'unit': 'volts'})
	_meta = _SmartDictionary({'time': _time, 'battery': _battery})
...
class WFTranslator(Translator):
	...
	_time = _SmartDictionary({'timestamp': 'time',
	                          'timezone':  'timezone'})


class WFStationTranslator(WFTranslator):
	_flat: _SmartDictionary
	_light = _SmartDictionary({'uv':              'uvi',
	                           'solar_radiation': 'irradiance',
	                           'brightness':      'illuminance'})
	_temperature = _SmartDictionary({'air_temperature':      'temperature',
	                                 'dew_point':            'dewpoint',
	...
	_wind = _SmartDictionary({'wind_direction':     'direction',
	                          'wind_avg':           'speed',
	                          'wind_lull':          'lull',
	                          'wind_gust':          'gust',
	                          'windSampleInterval': 'interval'})
	_precipitation = _SmartDictionary({'precip':                               'rate',
	...
	_pressure = _SmartDictionary({'barometric_pressure': 'pressure',
	                              'station_pressure':    'absolute',
	                              'sea_level_pressure':  'seaLevel',
	                              'air_density':         'airDensity',
	                              'pressure_trend':      'trend'})
	_lightning = _SmartDictionary({'lightning_strike_count':          'strikeCount',
