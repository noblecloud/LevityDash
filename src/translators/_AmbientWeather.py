...
class AWUnits(UnitTranslator):
	...
	_time = _SmartDictionary({'type': 'datetime', 'unit': 'ms'})
	_temperature = _SmartDictionary({'temperature': {'type': 'heat', 'unit': 'f'},
	                               'dewpoint':      {'type': 'heat', 'unit': 'f'},
	                               'feelsLike':     {'type': 'heat', 'unit': 'f'},
	                               'humidity':      {'type': 'saturation', 'unit': '%'}})
	_pressure = _SmartDictionary({'pressure': {'type': 'pressure', 'unit': 'inHg'},
	...
	_precipitation = _SmartDictionary({'rate':  {'type': 'rate', 'unit': ('in', 'hr')},
